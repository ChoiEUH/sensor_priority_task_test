...
osThreadId thermistorTask0Handle;
osThreadId gasTask03Handle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_ThermistorTask02 */
/**
* @brief Function implementing the thermistorTask0 thread.
* @param argument: Not used
* @retval None
*/
...
void ThermistorTask02(void const * argument)
{
  ...
  /* USER CODE END ThermistorTask02 */
}

/* USER CODE BEGIN Header_GasTask03 */
/**
* @brief Function implementing the gasTask03 thread.
* @param argument: Not used
* @retval None
*/
